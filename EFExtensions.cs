   ...
   public static class EFExtensions
    {
        ...
        public async static Task<IList<T>> ExecuteStoredProcAsync<T>(this System.Data.Common.DbCommand command)
        {
            using (command)
            {
                if (command.Connection.State == System.Data.ConnectionState.Closed)
        ...
        public static DataSet FillDataset(this DbCommand command)
        {
